...
public interface Marriage {
    ...
    /**
     * Return a {@link com.lenis0012.bukkit.marriage2.misc.BConfig} from a YAML
     * file.
     *
    ...
    /**
     * Return a {@link com.lenis0012.bukkit.marriage2.MPlayer} instance of a
     * player.
     *
     * @param uuid Unique user id of the wanted player.
     * @return {@link com.lenis0012.bukkit.marriage2.MPlayer} of the wanted
     * player.
     */
    MPlayer getMPlayer(UUID uuid);

    /**
     * Get a list of all married players. Note: This is IO, so please put it on
     * an async task.
     *
